...
# Lista as imagens disponiveis pela key do dicionario `imagens`
print("*** Imagens Disponiveis ***\n")
for key in images.keys():
    print(key)

# Le qual imagem o usuario quer analisar
image_to_run = input("Qual imagem deseja analisar?")

# Caso o usuario digite um valor invalido, ele executa o loop ate receber um valor valido
while image_to_run not in images.keys():
    print("Imagem não encontrada. Digite um dos seguintes valores:\n")
